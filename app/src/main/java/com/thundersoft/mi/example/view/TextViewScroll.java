package com.thundersoft.mi.example.view;
...
public class TextViewScroll extends TextView {
    ...
    private boolean scrollStatus = STOP;
    ...
    //判斷textview是否將內容顯示完整，如count＝＝０則說明沒有省略，count==２說明省略了兩行
    public boolean isEllip(){
        int count = getLayout().getEllipsisCount(getLineCount() - 1);
        //int num = getLineCount();
       // Log.d("yong", "count =" + count + ";num ="+num);
